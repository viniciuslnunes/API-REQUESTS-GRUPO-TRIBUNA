...
let linkf = "https://resultados.tse.jus.br/oficial/ele2020/divulgacao/oficial/426/fotos/sp/";
...
// Adiciona dados da cidade(DOM)
  ...
  fill() {
    try {
      ...
      document.getElementById("cidade-eleitores").innerHTML = dataEleitores.toLocaleString();
...
async function dataRefresh(resposta) {
  cidade(
    ...
    console.log("progress :"+resposta.progress+typeof resposta.progress+"  "+
    "eleitores :"+resposta.dataEleitores+ typeof resposta.dataEleitores+"  "+
    "votantes :"+resposta.dataVotantes+typeof resposta.dataVotantes+"  "+
    "ausentes :"+resposta.dataAusentes+typeof resposta.dataAusentes);
...
async function addTop1(top1) {
  ...
  if (top1.eleito != "s") {
    ...
    document.getElementById("top1-flag").innerHTML =
      top1.situacaosegundoturno.replace(/Â/g, "");
  }
}
...
async function addTop2(top2) {
  ...
  if (top2.eleito != "s") {
    ...
    document.getElementById("top2-flag").innerHTML =
      top2.situacaosegundoturno.replace(/Â/g, "");
  }
}
...
async function criarVereador(vereador, i) {
  ...
  divv.style.display = vereador.eleito == "s" ? "flex" : "none";
...
function cityChange(){
  ...
  const cidade = Array.from(params.keys())
